...
import { produtos, categorias, marcas, fmtBRLCompact } from '../lib/data.js';
  ...
  return (
    <div className="content">
      <div className="page-header">
        ...
        <div className="row">
          <button className="btn secondary"><Upload size={16} />Importar Excel</button>
          <button className="btn primary"><Plus size={16} />Adicionar produto</button>
        </div>
      </div>
